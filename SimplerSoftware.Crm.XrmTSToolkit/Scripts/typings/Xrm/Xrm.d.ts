...
// Derived from Project: http://msdn.microsoft.com/en-us/library/gg328255.aspx
// Definitions by: David Berry <https://github.com/6ix4our/>
// Updated definitions for CRM 2015 by: Steven Rasmussen
// Definitions: https://github.com/borisyankov/DefinitelyTyped
// Used with permission from David Berry
...
declare module Xrm {
    ...
    export module Page {
        ...
        * @sa  StandardControl
        */
        export interface NumberControl extends StandardControl {
            /**
             * Gets the control's bound attribute.
             *
             * @return  The attribute.
            ...
            /**
             * Sets the number of digits to use for the number control
             *
             * @param   {number}   precision   number of digits for the control.
             */
        ...
        export interface Ui {
            ...
            /** A reference to the process control */
            process: ProcessUIObject;
        }
    ...
    /** The process object for the Xrm.Page.data API */
    export interface ProcessDataObject {
         ...
         */
        getActiveProcess(): ProcessObject;

        /**
         * Set a Process as the active process.
         *
         * @param   {string}    processId           The Id of the process to make the active process.
         * @param   {Function}  callbackFunction    A function to call when the operation is complete. This callback function is passed one of the following string values to indicate whether the operation succeeded.
         *                      success
         *                      invalid
         */

        setActiveProcess(processId: string, callbackFunction?: Function): void;
         ...
         */
        getActiveStage(): StageObject;

        /**
         * Set a completed stage for the current entity as the active stage.
         * Only a completed stage for the current entity can be set using this method.
         *
         * @param   stageId             The ID of the completed stage for the current entity to make the active stage.
         * @param   callbackFunction    The callback function.
         */
        setActiveStage(stageId: string, callbackFunction?: Function): void;
         ...
         */
        getActivePath(): Array<StageObject>;

        /**
         * Use this method to asynchronously retrieve the enabled business process flows that the user
         * can switch to for an entity. The enabled processes are filtered according to the user’s
         * privileges. The list of enabled processes is the same ones a user can see in the UI if they
         * want to change the process manually.
         *
         * @param   {Function}  callbackFunction    The callback function must accept a parameter that
         *                                          contains an object with dictionary properties where the
         *                                          name of the property is the Id of the business process
         *                                          flow and the value of the property is the name of the
         *                                          business process flow.
         *
         * @return  The enabled processes.
         */
        getEnabledProcesses(callbackFunction: Function): Array<ProcessObject>;

        /**
         * Use this to add a function as an event handler for the OnStageChange event so that it will be
         * called when the business process flow stage changes.
         *
         * @param   {Function}  handler The function will be added to the bottom of the event handler
         *                              pipeline. The execution context is automatically set to be the
         *                              first parameter passed to the event handler.
         */
        addOnStageChange(handler: Function): void;
         ...
         */
        removeOnStageChange(handler: Function): void;

        /**
         * Use this to add a function as an event handler for the OnStageSelected event so that it will
         * be called when a business process flow stage is selected.
         *
         * @param   {Function}  handler The function will be added to the bottom of the event handler
         *                              pipeline. The execution context is automatically set to be the
         *                              first parameter passed to the event handler.
         */
        addOnStageSelected(handler: Function): void;
         ...
         * @param   {Function}  handler The function to be removed.
         */
        removeOnStageSelected(handler: Function): void;

        /**
         * Progresses to the next stage. This will cause the OnStageChange event to occur.
         *
         * @param   {Function}  callbackFunction    An optional function to call when the operation is
         *                                          complete.
         */
        moveNext(callbackFunction?: Function): void;

        /**
         * Progresses to the previous stage. This will cause the OnStageChange event to occur.
         *
         * @param   {Function}  callbackFunction    An optional function to call when the operation is complete.
         */
        movePrevious(callbackFunction?: Function): void;
    }
    ...
    /** Interface for process user interface object. */
    export interface ProcessUIObject {

        /**
         * Use this method to expand or collapse the business process flow control. "expanded" to expand
         * the control, "collapsed" to collapse it.
         *
         * @param   expanded:string The expanded string.
         */
        setDisplayState(expanded: string): void;

        /**
         * Use this method to show or hide the business process flow control.
         *
         * @param   {boolean}   visible true to show the control; otherwise, false.
         */
        setVisible(visible: boolean): void;
    }
}
